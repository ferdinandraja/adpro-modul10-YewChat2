            ...
            <div class="flex w-screen">
                ...
                <div class="grow h-screen flex flex-col">
                    ...
                    <div class="w-full grow overflow-auto border-b-2 border-gray-300">
                        {
                            self.messages.iter().map(|m| {
                                ...
                                html!{
                                    <div class="flex items-end w-3/6 bg-green-100 m-8 rounded-tl-lg rounded-tr-lg rounded-br-lg ">
                    ...
                    <div class="w-full h-14 flex px-3 items-center">
                        ...
                        <button onclick={submit} class="p-3 shadow-sm bg-green-600 w-10 h-10 rounded-full flex justify-center items-center color-white">
